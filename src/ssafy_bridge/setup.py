...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pub = ssafy_bridge.publisher:main',
            'sub = ssafy_bridge.subscriber:main',
            'odom_pub = ssafy_bridge.odom_pub:main',
            'path_pub = ssafy_bridge.path_pub:main',
            'odom_pub2 = ssafy_bridge.sense_odom_pub:main'
