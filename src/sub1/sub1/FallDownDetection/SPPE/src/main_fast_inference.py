...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file='C:/Ddrive/2021/ssafy2/Iot/git/S05P21A103/install/sub1/Lib/site-packages/sub1/FallDownDetection/Detection/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
